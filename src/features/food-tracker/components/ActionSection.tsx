...
const ActionSection = ({
  ...
  return (
    <Card className="p-3 bg-gradient-to-br from-white via-brand-primary-50 to-pink-50 border-brand-neutral-200 shadow-sm">
      <div className={`flex items-center gap-2 mb-3 ${isRTL ? 'flex-row-reverse' : ''}`}>
        <div className="w-5 h-5 bg-gradient-to-r from-brand-primary-600 to-brand-secondary-600 rounded-full flex items-center justify-center">
