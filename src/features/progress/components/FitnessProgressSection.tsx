...
import { useExerciseProgram } from "@/features/exercise/hooks/core/useExerciseProgram";

export const FitnessProgressSection = () => {
  const navigate = useNavigate();
  
  const { currentProgram, completedExercises, totalExercises, progressPercentage } = useExerciseProgram();

  const activePrograms = currentProgram ? [currentProgram] : [];
