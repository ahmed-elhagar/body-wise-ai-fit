...
import { useLifePhaseProfile } from "@/features/profile/hooks/useLifePhaseProfile";
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle className={`flex items-center gap-2 ${isRTL ? 'flex-row-reverse' : ''}`}>
            <Sparkles className="w-5 h-5 text-blue-6brand-neutral-600brand-neutral-600" />
        ...
        <div className="space-y-6 py-4">
          ...
          {(nutritionContext.pregnancyTrimester || nutritionContext.breastfeedingLevel || nutritionContext.fastingType || nutritionContext.isMuslimFasting) && (
            <div className="bg-health-soft border border-health-border rounded-lg p-4">
              ...
              <Badge 
                variant="secondary" 
                className={`bg-gradient-to-r from-health-primary/1brand-neutral-600 to-health-secondary/1brand-neutral-600 text-health-primary border-health-primary/2brand-neutral-600 ${isRTL ? 'flex-row-reverse' : ''}`}
              >
                {getLifePhaseIcon()}
                <span className={isRTL ? 'mr-2' : 'ml-2'}>{getLifePhaseLabel()}</span>
              </Badge>
              {nutritionContext.extraCalories > brand-neutral-600 && (
              ...
              {nutritionContext.isMuslimFasting && nutritionContext.fastingStartDate && nutritionContext.fastingEndDate && (
                <p className="text-xs text-blue-6brand-neutral-600brand-neutral-600 mt-1">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Select
                value={preferences.maxPrepTime || '3brand-neutral-600'}
              ...
              >
                ...
                <SelectContent>
                  <SelectItem value="3brand-neutral-600">3brand-neutral-600 {t('minutes')}</SelectItem>
                  <SelectItem value="45">45 {t('minutes')}</SelectItem>
                  <SelectItem value="6brand-neutral-600">6brand-neutral-600 {t('minutes')}</SelectItem>
                </SelectContent>
              </Select>
            </div>
          ...
          <div className={`flex gap-3 ${isRTL ? 'flex-row-reverse' : ''}`}>
            ...
            <Button 
              ...
              className="flex-1 bg-gradient-to-r from-blue-6brand-neutral-600brand-neutral-600 to-indigo-6brand-neutral-600brand-neutral-600 hover:from-blue-7brand-neutral-600brand-neutral-600 hover:to-indigo-7brand-neutral-600brand-neutral-600"
            >
              {isGenerating ? (
                <>
