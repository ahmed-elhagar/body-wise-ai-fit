...
import { MessageSquare, Users, Bot, Phone, Video, Settings, Sparkles } from "lucide-react";
      ...
      <div className="container mx-auto p-6 space-y-6">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-gray-600 text-lg max-w-2xl mx-auto">
            {t('Get instant help from our AI assistant or connect with your personal coaches')}
          </p>
        </div>
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <CardContent>
                <p className="text-gray-600 mb-4 leading-relaxed">
                  {t('Get instant answers to your fitness and nutrition questions with personalized AI guidance')}
                </p>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <h3 className="font-bold text-xl bg-gradient-to-r from-purple-600 to-purple-700 bg-clip-text text-transparent">
                    ...
                    >
                      <CardHeader className="pb-4">
                        <div className="flex items-center justify-between">
                          ...
                          {unreadCount > 0 && (
                            <Badge className="bg-gradient-to-r from-red-500 to-red-600 text-white border-0 animate-pulse">
                              {unreadCount}
                            </Badge>
                          )}
                        </div>
