...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'mealPlan.personalizedPlan': 'Personalized nutrition for your fitness goals',
    'mealPlan.calPerDay': 'cal/day',
    'mealPlan.weeklyCalories': 'Weekly Calories',
    'mealPlan.weeklyProtein': 'Weekly Protein',
    'mealPlan.noMealsPlanned': 'No meals planned for this day',
    'mealPlan.noMealPlanToShuffle': 'No meal plan found to shuffle',
    ...
    'mealPlan.previousWeek': 'Previous Week',
    'mealPlan.dailyViewHelper': 'View detailed daily meal breakdown',
    'mealPlan.weeklyViewHelper': 'Overview of your entire week',
    'mealPlan.todaysSummary': "Today's Summary",
    'mealPlan.weeklyOverview': 'Weekly Overview',
  ...
  ar: {
    ...
    'mealPlan.cal': 'سعرة',
    'mealPlan.protein': 'بروتين',
    'mealPlan.carbs': 'كربوهيدرات',
    'mealPlan.fat': 'دهون',
    'mealPlan.min': 'دقيقة',
    'mealPlan.calories': 'السعرات الحرارية',
    'mealPlan.weeklyMealPlan': 'خطة الوجبات الأسبوعية',
    'mealPlan.personalizedPlan': 'تغذية مخصصة لأهداف لياقتك',
    'mealPlan.calPerDay': 'سعرة/يوم',
    'mealPlan.weeklyCalories': 'السعرات الأسبوعية',
    'mealPlan.weeklyProtein': 'البروتين الأسبوعي',
    'mealPlan.noMealsPlanned': 'لا توجد وجبات مخططة لهذا اليوم',
    'mealPlan.noMealPlanToShuffle': 'لا توجد خطة وجبات للخلط',
    ...
    'mealPlan.previousWeek': 'الأسبوع السابق',
    'mealPlan.dailyViewHelper': 'عرض تفصيلي لوجبات اليوم',
    'mealPlan.weeklyViewHelper': 'نظرة عامة على الأسبوع كاملاً',
    'mealPlan.todaysSummary': 'ملخص اليوم',
    'mealPlan.weeklyOverview': 'نظرة عامة أسبوعية',
