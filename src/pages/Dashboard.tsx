      ...
      <div className="flex-1 ml-0 md:ml-64 transition-all duration-300">
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="mb-8 text-center">
            <div className="inline-flex items-center gap-3 bg-white/80 backdrop-blur-sm rounded-2xl px-6 py-4 shadow-xl mb-4">
              <div className="w-12 h-12 bg-fitness-gradient rounded-xl flex items-center justify-center">
                <span className="text-2xl">👋</span>
              </div>
              <div className="text-left">
                <h1 className="text-3xl font-bold bg-gradient-to-r from-fitness-primary to-pink-600 bg-clip-text text-transparent">
            ...
            {profile?.ai_generations_remaining !== undefined && (
              <div className="inline-flex items-center gap-2 bg-gradient-to-r from-fitness-primary/10 to-pink-100 rounded-full px-4 py-2">
