      ...
      <div className="space-y-4">
              ...
              >
                <div className="flex flex-col items-center">
                  ...
                  <span className="text-xs opacity-75">
                    {isRest ? (
                      <span className="text-orange-600">{t('exercise.rest')}</span>
                    ) : hasData ? (
        ...
        <div className="flex items-center justify-center space-x-3 sm:space-x-4 text-xs text-gray-600">
          <div className="flex items-center">
            ...
            <span className="sm:hidden">{t('exercise.workout')}</span>
          </div>
          <div className="flex items-center">
            <div className="w-2 h-2 bg-orange-500 rounded-full mr-1"></div>
            <span className="hidden sm:inline">{t('exercise.restDay')}</span>
            <span className="sm:hidden">{t('exercise.rest')}</span>
          </div>
          <div className="flex items-center">
            <div className="w-2 h-2 bg-gray-300 rounded-full mr-1"></div>
            <span className="hidden sm:inline">{t('exercise.noWorkout')}</span>
            <span className="sm:hidden">{t('exercise.empty')}</span>
          </div>
        </div>
      </div>
    </Card>
