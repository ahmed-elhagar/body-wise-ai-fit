        ...
        {dayNames.map((day, index) => {
          ...
          return (
            <Button
              ...
              className={`
                relative h-auto p-2 flex flex-col items-center gap-1 transition-all duration-300
                ${isSelected 
            ...
            >
              ...
              {/* Status Badge with Icon beside */}
              <div className="flex items-center gap-1">
                {status === 'rest' ? (
                  <>
                    <Coffee className={`w-3 h-3 ${isSelected ? 'text-orange-200' : 'text-orange-500'}`} />
                    <Badge variant="outline" className={`border-0 text-xs px-1 py-0 ${
                      isSelected ? 'bg-orange-500/20 text-orange-200 hover:bg-orange-500/30' : 'bg-orange-100 text-orange-600 hover:bg-orange-200'
                    }`}>
                      Rest
                    </Badge>
                  </>
                  ...
                  <>
                    ...
                    <Badge variant="outline" className={`border-0 text-xs px-1 py-0 ${
                      isSelected ? 'bg-green-500/20 text-green-200 hover:bg-green-500/30' : 'bg-green-100 text-green-600 hover:bg-green-200'
                    }`}>
                      Done
                    </Badge>
                  </>
                  ...
                  <>
                    ...
                    <Badge variant="outline" className={`border-0 text-xs px-1 py-0 ${
                      isSelected ? 'bg-yellow-500/20 text-yellow-200 hover:bg-yellow-500/30' : 'bg-yellow-100 text-yellow-600 hover:bg-yellow-200'
                    }`}>
                      {progress}%
                    </Badge>
                  </>
                  ...
                  <>
                    ...
                    <Badge variant="outline" className={`border-0 text-xs px-1 py-0 ${
                      isSelected ? 'bg-blue-500/20 text-blue-200 hover:bg-blue-500/30' : 'bg-blue-100 text-blue-600 hover:bg-blue-200'
                    }`}>
                      Ready
                    </Badge>
                  </>
