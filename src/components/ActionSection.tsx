        ...
        <div className={`flex gap-2 justify-end ${isRTL ? 'flex-row-reverse justify-start' : ''}`}>
          ...
          {showAddSnack && (
            <Button
              variant="outline"
              size="sm"
              className="bg-white/90 border-green-200 text-green-700 hover:bg-green-50 hover:border-green-300 hover:text-green-800 transition-all duration-300 shadow-md hover:shadow-lg font-medium rounded-lg px-4 py-2"
              onClick={onAddSnack}
            >
