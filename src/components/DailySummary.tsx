    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-2">
        <Card className="p-3 bg-gradient-to-br from-blue-50 to-blue-100 border-0">
          <div className="text-center">
            <div className="text-lg font-bold text-blue-800">{Math.round(totalCalories / 5)}</div>
        ...
        <Card className="p-3 bg-gradient-to-br from-purple-50 to-purple-100 border-0">
          <div className="text-center">
            <div className="text-lg font-bold text-purple-800">{Math.round(totalProtein / 5)}</div>
